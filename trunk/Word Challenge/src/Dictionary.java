...
public class Dictionary {
	...
	/**
	 * ArrayList conteniendo todas las palabras de seis letras de longitud que
	 * aún no han sido utilizadas.
	 */
	 ...
	 * 
	 * @param wordlist
	 *            : palabras que acepta el diccionario
	 */
	 ...
	 * 
	 * @param wordlist
	 *            : conjunto de palabras contenidas por el diccionario
	 */
	 ...
	 * 
	 * @param newWords
	 *            : conjunto totalmente renovado de palabras
	 */
	...
	/**
	 * Método para devolver todas las palabras existentes dado un conjunto de
	 * letras.
	 * 
	 * @param letters
	 *            : conjunto de letras
	 * @param wordList
	 *            : ArrayList donde se depositan las palabras encontradas
	 */
	private void addExistentWords(final String letters,
		...
		while (indexPos[0] < letters.length()) {
			...
			if (!sameIndexes(indexPos)) {
				...
				// Ciclo que forma una potencial palabra con las letras
				// apuntadas
				// por el arreglo de índices
				for (int i = 0; i < letters.length(); i++) {
					aux = new String(aux
							+ letters.substring(indexPos[i], indexPos[i] + 1));
				}
	 ...
	 *            : conjunto de letras
	 * @param sizeGroup
	 *            : tamaño de los subconjuntos de letras
	 * @param lettersGroup
	 *            : ArrayList donde se depositan las subconjuntos encontradas
	 */
	 ...
	 * 
	 * @param newWord
	 *            : palabra que se agrega al diccionario
	 */
	...
	/**
	 * Devuelve el valor de la variable unusedSixLetteredWord.
	 * 
	 * @return unusedSixLetteredWord
	 */
	public ArrayList<String> getUnusedSixLetteredWord() {
		return unusedSixLetteredWord;
	}

	/**
	 * 
	 * Setea el valor de la variable unusedSixLetteredWord la cual contiene
	 * todas las palabras de seis letras de longitud que aún no han sido
	 * utilizadas.
	 * 
	 * @param unusedSixLetteredWord
	 */
	public final void setUnusedSixLetteredWord(
			final ArrayList<String> unusedSixLetteredWord) {
		this.unusedSixLetteredWord = unusedSixLetteredWord;
	}

	/**
	 * Devuelve el valor de la variable LONGEST_WORD.
	 * 
	 * @return LONGEST_WORD
	 */
	public static int getLONGEST_WORD() {
		return LONGEST_WORD;
	}

	/**
	 * Setea el valor de la variable LONGEST_WORD.
	 * 
	 * @param longest_word
	 */
	public static void setLONGEST_WORD(int longest_word) {
		LONGEST_WORD = longest_word;
	}

	/**
	 * Devuelve el valor de la variable SMALLEST_WORD.
	 * 
	 * @return SMALLEST_WORD
	 */
	public static int getSMALLEST_WORD() {
		return SMALLEST_WORD;
	}

	/**
	 * Setea el valor de la variable SMALLEST_WORD.
	 * 
	 * @param smallest_word
	 */
	public static void setSMALLEST_WORD(int smallest_word) {
		SMALLEST_WORD = smallest_word;
	}

	/**
	 * Devuelve todas las palabras de seis letras.
	 * 
	...
	/**
	 * Setea el valor de la variable sixLetteredWord.
	 * 
	 * @param sixLetteredWord
	 */
	public final void setSixLetteredWord(final ArrayList<String> 
										 sixLetteredWord) {
