...
public class Level extends GameObject implements Observer {
	 ...
	 */
	private String holeImage = "../big balls/resources/images/agujerov3.png";
	...
	public final void update(final Observable o, final Object arg) {
		playSound("../big balls/resources/sounds/clocktick.wav");
	...
	public final void initResources() {
		...
		Background collMask = 
			new ImageBackground(getImage("../big balls/resources/images/collmask.png"), 
				800, 441);
		...
		font = new SystemFont(FontUtil.createTrueTypeFont(
				this.bsIO.getURL("../big balls/resources/images/MaroonedOnMarsBB.ttf"), Font.BOLD, 40f));
		...
		salir = new Sprite(ImageUtil.getImage(
				bsIO.getURL("../big balls/resources/images/ingamesalir.png"), 
				Transparency.TRANSLUCENT));
		salir.setLocation(750, 5);
		playfield.add(salir);
		
		//Inicializacion del reloj
		clockSprite = new AnimatedSprite(ImageUtil.getImages(this.bsIO.getURL("../big balls/resources/images/clock.png"), 7, 1, Transparency.TRANSLUCENT));
		...
		if ((click()) && (!timerEndLevel.isActive())) {
			...
			if (ballsel != null) {
				if (ballsel.getValue() == this.orderedBalls.elementAt(pos)
					...
					playSound("../big balls/resources/sounds/winball.wav");
					fillHole(ballsel);
					this.pos++;
	...
	public final void generateWinAnimation() {
		Sprite overlay = new Sprite(ImageUtil.getImage(
				this.bsIO.getURL("../big balls/resources/images/overlay.png"),
				Transparency.TRANSLUCENT));
		AdvanceSprite win = new AdvanceSprite(ImageUtil.getImages(
				this.bsIO.getURL("../big balls/resources/images/tick.png"), 6, 1,
				Transparency.TRANSLUCENT));
	...
	public final void generateLoseAnimation() {
		...
		AdvanceSprite lose = new AdvanceSprite(ImageUtil.getImages(
				this.bsIO.getURL("../big balls/resources/images/fail.png"), 6, 1,
				Transparency.TRANSLUCENT));
